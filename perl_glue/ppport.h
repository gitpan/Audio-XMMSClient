...
----------------------------------------------------------------------
    ...
    perl_glue/ppport.h -- Perl/Pollution/Portability Version 3.06_01

    Automatically created by Devel::PPPort running under
    perl 5.008008 on Sun Oct 15 04:17:48 2006.

    Do NOT edit this file directly! -- Edit PPPort_pm.PL and the
    includes in parts/inc/ instead.

    Use 'perldoc perl_glue/ppport.h' to view the documentation below.
...
=head1 SYNOPSIS
  ...
  perl perl_glue/ppport.h [options] [source files]
...
This version of F<perl_glue/ppport.h> is designed to support operation with Perl
...
Tell F<perl_glue/ppport.h> to check for compatibility with the given
Perl version. The default is to check for compatibility with Perl
version 5.003. You can use this option to reduce the output
of F<perl_glue/ppport.h> if you intend to be backward compatible only
up to a certain Perl version.

=head2 --cplusplus

Usually, F<perl_glue/ppport.h> will detect C++ style comments and
replace them with C style comments for portability reasons.
Using this option instructs F<perl_glue/ppport.h> to leave C++
comments untouched.
...
F<perl_glue/ppport.h>. Also lists if it must be explicitly requested,
if it has dependencies, and if there are hints for it.

=head2 --list-unsupported

Lists the API elements that are known not to be supported by
F<perl_glue/ppport.h> and below which version of Perl they probably
...
earlier Perl releases. Use
    ...
    perl perl_glue/ppport.h --list-provided

to see which API elements are provided by perl_glue/ppport.h.
...
also deprecated. You can safely use the supported API, as F<perl_glue/ppport.h>
...
more C<#define>s in your source code before the inclusion of F<perl_glue/ppport.h>.
...
Just C<#define> the macro before including C<perl_glue/ppport.h>:

    #define DPPP_NAMESPACE MyOwnNamespace_
    #include "perl_glue/ppport.h"
...
F<perl_glue/ppport.h> on your source code. See the next section for
details.

=head1 EXAMPLES

To verify whether F<perl_glue/ppport.h> is needed for your module, whether you
should make any changes to your code, and whether any special defines
should be used, F<perl_glue/ppport.h> can be run as a Perl script to check your
source code. Simply say:

    perl perl_glue/ppport.h
...
use something like this:
    ...
    perl perl_glue/ppport.h --compat-version=5.6.0 --cplusplus --patch=test.diff

If you only want your code to be scanned without any suggestions
for changes, use:

    perl perl_glue/ppport.h --nochanges

You can specify a different C<diff> program or options, using
the C<--diff> option:

    perl perl_glue/ppport.h --diff='diff -C 10'
...
use:
    ...
    perl perl_glue/ppport.h --api-info=newSVpvn

Since the argument to C<--api-info> can be a regular expression,
you can use

    perl perl_glue/ppport.h --api-info=/_nomg$/

to display portability information for all C<_nomg> functions or

    perl perl_glue/ppport.h --api-info=/./

to display information for all known API elements.

=head1 BUGS

If this version of F<perl_glue/ppport.h> is causing failure during
the compilation of this module, please check if newer versions
of either this module or C<Devel::PPPort> are available on CPAN
before sending a bug report.

If F<perl_glue/ppport.h> was generated using the latest version of
 ...
 */
#if PERL_REVISION != 5
#  error perl_glue/ppport.h only works with Perl version 5
...
/* Hint: SvPVbyte
 * Does not work in perl-5.6.1, perl_glue/ppport.h implements a version
...
/* End of File perl_glue/ppport.h */
